...
cpdef enum SVGpaintType:
    SVG_PAINT_NONE = NSVGpaintType.NSVG_PAINT_NONE
    SVG_PAINT_COLOR = NSVGpaintType.NSVG_PAINT_COLOR
    SVG_PAINT_LINEAR_GRADIENT = NSVGpaintType.NSVG_PAINT_LINEAR_GRADIENT
